            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter ..." name="judul_prodi"
                           value="{{$submisi->judul_prodi}}" disabled>
                    @error('judul_prodi')
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select form-control-border border-width-2" id="status_prodi"
                        ...
                        <option value="Pending" {{ $submisi->status_prodi == 'Pending' ? 'selected' : '' }}>Pending
                        </option>
                        <option value="Diterima" {{ $submisi->status_prodi == 'Diterima' ? 'selected' : '' }}>
                            Diterima
                        </option>
                        <option value="Ditolak" {{ $submisi->status_prodi == 'Ditolak' ? 'selected' : '' }}>Ditolak
                        </option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control custom-textarea" style="height: 400px"
                              ...
                              disabled>{{ $submisi->keterangan_prodi }}</textarea>
