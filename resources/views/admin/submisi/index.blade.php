...
<section class="content">
    <div class="dash-notice">
        <div class="tambah-redaksi">
            <a href="/admin/submisi/store">List Pengajuan</a>
        </div>
        ...
        <tr>
            <td>
                ...
                <div class="action-container">
                    <div>
                        <a href="/admin/submisi/{{$submisi->id}}/edit" class="action-edit">Edit</a>
                    </div>
            ...
            <td>{{implode(' ', array_slice(explode(' ', $submisi->keterangan_prodi), 0, 50))}}...</td>
            <td><a href="/admin/submisi/{{$submisi->id}}/edit">Review</a></td>
        </tr>    
        @endforeach
        </tbody>
    </table>
