...
<section class="content">
    <div class="dash-notice">
        <div class="tambah-redaksi">
            <a href="/pemohon/organisasi/store">Ajukan Proposal Kegiatan</a>
        </div>
        ...
        <tr>
            <td>
                ...
                <div class="action-container">
                    <div>
                        <a href="/pemohon/organisasi/{{$organisasi->id}}/show" class="action-edit">Edit</a>
                    </div>
            ...
            <td><a href="/pemohon/organisasi/{{$organisasi->id}}/show">Review</a></td>
        </tr>    
        @endforeach
        </tbody>
    </table>
