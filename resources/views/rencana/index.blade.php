...
<section class="content">
    <div class="dash-notice">
        <div class="tambah-redaksi">
            <a href="/pemohon/rencana/store">Pengajuan Rencana</a>
        </div>
        ...
        <tr>
            <td>
                ...
                <div class="action-container">
                    <div>
                        <a href="/pemohon/rencana/{{$rencana->id}}/show" class="action-edit">Edit</a>
                    </div>
            ...
            <td><a href="/pemohon/rencana/{{$rencana->id}}/show">Review</a></td>
        </tr>    
        @endforeach
        </tbody>
    </table>
